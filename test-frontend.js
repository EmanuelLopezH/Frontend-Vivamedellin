...
console.log('%c🧪 VERIFICACIÓN RÁPIDA DE VIVEMEDELLIN', 'color: blue; font-size: 20px; font-weight: bold');
...
fetch('http://localhost:8081/api/users/login', {
  ...
  .then(() => {
    console.log('✅ Backend está accesible en puerto 8081');
  })
  .catch((error) => {
    console.log('❌ Backend NO está accesible:', error.message);
    console.log('💡 Asegúrate de iniciar el backend en puerto 8081');
  });
